                           ...
                           bool_t *sve)
{
    ...
    *a = p2m_access_n;
    ...
    //printk("ept_get_entry is called, gfn:%lu, i:%d\n", gfn, i);
...
static int ept_migrate_page_range(struct p2m_domain *p2m,
                                       unsigned long first_gfn,
                                       unsigned long last_gfn,
					int move_to_node)
{
	printk("ept_migrate_page_range is called\n");
	return 0;	
}
...
int ept_p2m_init(struct p2m_domain *p2m)
{
    ...
    p2m->migrate_page_range = ept_migrate_page_range;
