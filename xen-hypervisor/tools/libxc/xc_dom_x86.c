...
static int meminit_hvm(struct xc_dom_image *dom)
{
    ...
    else
    {
       // if ( nr_pages > target_pages )
       // {
       //     printf("I'm here at meminit_hvm, and I'm about to go out cause vNUMA and PoD incompatibility\n");
    ...
    if ( memflags & XENMEMF_populate_on_demand )
    {
        ...
        if ( rc != 0 )
        {
	    printf("I'm here at meminit_hvm, and I'm about to go out cause hvm and PoD incompatibility\n");
    ...
    for ( vmemid = 0; vmemid < nr_vmemranges; vmemid++ )
    {
        ...
        if ( rc != 0 )
        {
	    printf("I'm here at meminit_hvm N\n");
