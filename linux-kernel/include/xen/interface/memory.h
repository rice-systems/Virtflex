...
#define XENMEM_decrease_reservation_2 29
#define XENMEM_populate_physmap_2     30
#define XENMEM_migrate_page_range 31
...
struct xen_memory_range_migration {
	xen_ulong_t start_addr;
	xen_ulong_t end_addr;
	domid_t        domid;
	int16_t move_to_node;
};
typedef struct xen_memory_range_migration xen_memory_range_migration_t;
DEFINE_GUEST_HANDLE_STRUCT(xen_memory_range_migration_t);
...
DEFINE_GUEST_HANDLE_STRUCT(xen_vmemrange_t);
...
DEFINE_GUEST_HANDLE_STRUCT(xen_vnuma_topology_info_t);
