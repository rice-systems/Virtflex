...
xl vcpu-pin $DOMID 4 16 16
xl vcpu-pin $DOMID 5 17 17
xl vcpu-pin $DOMID 6 18 18
xl vcpu-pin $DOMID 7 19 19

xl vcpu-pin $DOMID 8 32 32
xl vcpu-pin $DOMID 9 33 33
xl vcpu-pin $DOMID 10 34 34
xl vcpu-pin $DOMID 11 35 35

xl vcpu-pin $DOMID 12 48 48
xl vcpu-pin $DOMID 13 49 49
xl vcpu-pin $DOMID 14 50 50
xl vcpu-pin $DOMID 15 51 51

xl vcpu-pin $DOMID 16 4 4
xl vcpu-pin $DOMID 17 5 5
xl vcpu-pin $DOMID 18 6 6
xl vcpu-pin $DOMID 19 7 7

xl vcpu-pin $DOMID 20 20 20
xl vcpu-pin $DOMID 21 21 21
xl vcpu-pin $DOMID 22 22 22
xl vcpu-pin $DOMID 23 23 23

xl vcpu-pin $DOMID 24 36 36
xl vcpu-pin $DOMID 25 37 37
xl vcpu-pin $DOMID 26 38 38
xl vcpu-pin $DOMID 27 39 39

xl vcpu-pin $DOMID 28 52 52
xl vcpu-pin $DOMID 29 53 53
xl vcpu-pin $DOMID 30 54 54
xl vcpu-pin $DOMID 31 55 55
